...
public class Manhattan {
    ...
    public static void AstarManhattan(String InitialState) throws IOException {
            double start = System.nanoTime();

        //here we started to use a file writer to make the output in a file
        FileWriter fileWriter = new FileWriter("8 Puzzle Manhattan Solution.txt");
        ...
        Node InitialStateNode=new Node(InitialState,null,null);
            int currentH = Work_Space.GetHManhattan(Work_Space.toBoardArray(InitialState));
        ...
        while (!Nodeq.isEmpty()) {
            ...
            //check if we reached the goal
                if (nodeToExplore.value.equals(goal1.value)) {
                    ...
                    System.out.println("Execution time of Manhattan distance: " + execution/100000000 + " seconds");
                    file.println("Execution time of Manhattan distance: " + execution/100000000 + " seconds");
                    break;
                }
            ...
            // getting 1st neighbour
                if (zeroX != 0) {
                    ...
                    if (!Explored.contains(boardString)) {
                        ...
                        int currentH1=Work_Space.GetHManhattan(Work_Space.toBoardArray(nodeToExplore.node1.value));
            ...
            // getting 2nd neighbour
                if (zeroY != 0) {
                    ...
                    if (!Explored.contains(boardString)) {
                        ...
                        int currentH2=Work_Space.GetHManhattan(Work_Space.toBoardArray(nodeToExplore.node2.value));
            ...
            //  getting 3rd neighbour
                if (zeroY != 2) {
                    ...
                    if (!Explored.contains(boardString)) {
                        ...
                        int currentH3=Work_Space.GetHManhattan(Work_Space.toBoardArray(nodeToExplore.node3.value));
            ...
            // getting 4th neighbour
                if (zeroX != 2) {
                    ...
                    if (!Explored.contains(boardString)) {
                        ...
                        int currentH4=Work_Space.GetHManhattan(Work_Space.toBoardArray(nodeToExplore.node4.value));
                ...
                for (int i=0;i< Nodeq.size();i++){
                    currentH=Work_Space.GetHManhattan(Work_Space.toBoardArray(nodeToExplore.value));
                    int newH=Work_Space.GetHManhattan(Work_Space.toBoardArray(Nodeq.peek().getKey().value));
                    if (newH<currentH){
                        currentH=newH;
                    }
                }
