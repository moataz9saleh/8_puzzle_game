...
public class BFS{
    ...
    public static void bfs(String InitialState) throws IOException {
        ...
        while (!Frontier.isEmpty()) {
           ...
           String parent=Work_Space.toBoardString(board);
            ...
            if (nodeToExplore.value.equals(goal1.value)) {
                ...
                System.out.println("Execution time of Breadth first search: " + execution/100000000 + " seconds");
                file.println("Execution time of Breadth first search: " + execution/100000000 + " seconds");
                break;
            }
